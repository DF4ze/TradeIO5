...
public class MacroMarketOpinion implements MarketOpinion {
    ...
    public void decide(OpinionContext context, MarketOpinionParameters parameters) {
        ...
        // Opinion MACRO : jamais de symbole (signal d'ambiance, cf. javadoc classe) — quel que soit le
        // symbole reçu dans le contexte (ex: appelé par l'orchestrateur, Palier 3 étape 7), il n'est jamais
        // reporté sur l'OpinionEvent publié. Fix du 2026-08-14 (même correctif que GlobalMarketOpinion) :
        // l'ancienne "vérification défensive" propageait par erreur ce symbole, cassant le filtre de
        // scénario global (ScenarioKey.symbol().isEmpty()).
