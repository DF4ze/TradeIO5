...
@SpringBootTest
class RiskManagementMarketOpinionTest_UT {
  ...
  /*  @Test
    void testDecisionWithDifferentRiskProfiles() {
        ...
        // --- Test profil LOW ---
        OpinionResult lowResult = decision.interpretSignals(signals, context, lowParams);
        System.out.println("LOW profile action: " + lowResult.getAction());
        assertEquals(MarketAction.HOLD, lowResult.getAction());

        // --- Test profil MEDIUM ---
        OpinionResult mediumResult = decision.interpretSignals(signals, context, mediumParams);
        System.out.println("MEDIUM profile action: " + mediumResult.getAction());
        assertEquals(MarketAction.HOLD, mediumResult.getAction());

        // --- Test profil HIGH ---
        OpinionResult highResult = decision.interpretSignals(signals, context, highParams);
