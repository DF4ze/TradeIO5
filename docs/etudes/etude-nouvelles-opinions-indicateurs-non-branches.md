...
> `docs/suivi/etat-des-lieux-indicateurs-strategies-opinions.md` §8.
...
voir `docs/suivi/etat-des-lieux-indicateurs-strategies-opinions.md` §2-4), en réfléchissant aux
...
`docs/etudes/etude-extension-risk-macro-external.md` §3.3 recommandait explicitement de ne pas séparer
...
> branchée, cf. `docs/etudes/etude-branchement-etf-flow-confidence-modulator.md`. Nuance : volontairement
...
| ETF_FLOW | `EtfFlowConfidenceStrategy` (`CONFIDENCE_MODULATOR`), branchée le 2026-07-16 mais **pas** ajoutée par défaut à `DefaultMarketOpinion` (ad hoc uniquement) | — | Fait (cf. `docs/etudes/etude-branchement-etf-flow-confidence-modulator.md`) |
