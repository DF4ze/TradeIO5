...
Prompt autonome, à la suite des Lots 1 et 2 (`docs/prompts/prompt-implementation-lot1-indicateurs.md`, `docs/prompts/prompt-implementation-lot2-indicateurs.md`). Couvre le **Lot 3** défini dans `docs/etudes/etude-indicateurs-macro-externes.md` (§14) : Flow ETF (scraping) et Zones de rejet. Contrairement aux deux lots précédents, **aucun des deux items n'a de dépendance technique sur le Lot 1/Lot 2** — ils peuvent être développés en parallèle l'un de l'autre, et démarrés sans attendre quoi que ce soit d'autre.
...
1. `docs/etudes/etude-indicateurs-macro-externes.md` — §1, §5.
