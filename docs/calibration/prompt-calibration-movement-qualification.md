...
même limitation que celle documentée dans `docs/calibration/calibration-rejection-zone.md` : trafic sortant
...
2. `docs/calibration/calibration-rejection-zone.md` — protocole de référence (calibration visuelle, test
...
2. `docs/calibration/calibration-movement-qualification.md`, même structure que
   `docs/calibration/calibration-rejection-zone.md` : données utilisées (avec la profondeur d'historique
