...
Complément à `docs/calibration/prompt-calibration-movement-qualification.md` et au protocole de référence
`docs/calibration/calibration-rejection-zone.md` (même méthodologie : calibration visuelle/fréquence, test
...
Même limitation que documentée dans `docs/calibration/calibration-rejection-zone.md` (trafic sortant du bac à
...
`docs/calibration/calibration-rejection-zone.md`) — la fenêtre 2026-04-25→2026-07-16 sera obsolète dès que la
