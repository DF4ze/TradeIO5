...
`docs/calibration-rejection-zone.md`/`docs/prompt-calibration-movement-qualification.md` : trafic
...
du 2026-07-17 (`docs/etude-cache-etf-flow-historisation.md`, addendum Farside) a rempli
...
3. `docs/calibration-rejection-zone.md` et `docs/prompt-calibration-movement-qualification.md` —
...
4. `docs/etude-cache-etf-flow-historisation.md` — comprendre `etf_flow_snapshot` (colonnes
...
1. `tools/calibration/export_etf_flow_history.py` et `tools/calibration/etf_flow_calibration.py`,
   ...
   scripts jetables).
2. `docs/calibration-etf-flow.md`, même structure que `docs/calibration-movement-qualification.md` :
